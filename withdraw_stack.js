...
let withdrawTx = await StakeProgram.withdraw({stakePubkey: stakeAccount.publicKey, authorizedPubkey: wallet.publicKey, toPubkey: wallet.publicKey, lamports:stakeBalance});
let withdrawTxId = await sendAndConfirmTransaction(connection,withdrawTx, [wallet]);
